...
public extension Publisher {
     ...
     * - returns: Return `LoadingStatePublisher` containing the combined data.
     */
    func zipState<PUBLISHER_2, PUBLISHER_3, RAW_CONTENT_1, RAW_CONTENT_2, RAW_CONTENT_3, OUTPUT>(_ statePublisher2: PUBLISHER_2, _ statePublisher3: PUBLISHER_3, _ transform: @escaping (_ rawContent1: RAW_CONTENT_1, _ rawContent2: RAW_CONTENT_2, _ rawContent3: RAW_CONTENT_3) -> OUTPUT) -> AnyPublisher<LoadingState<OUTPUT>, Self.Failure> where Self.Output == LoadingState<RAW_CONTENT_1>, PUBLISHER_2: Publisher, PUBLISHER_2.Output == LoadingState<RAW_CONTENT_2>, Self.Failure == PUBLISHER_2.Failure, PUBLISHER_3: Publisher, PUBLISHER_3.Output == LoadingState<RAW_CONTENT_3>, Self.Failure == PUBLISHER_3.Failure {
     ...
     * - returns: Return `LoadingStatePublisher` containing the combined data.
     */
     func zipState<PUBLISHER_2, PUBLISHER_3, PUBLISHER_4, RAW_CONTENT_1, RAW_CONTENT_2, RAW_CONTENT_3, RAW_CONTENT_4, OUTPUT>(_ statePublisher2: PUBLISHER_2, _ statePublisher3: PUBLISHER_3, _ statePublisher4: PUBLISHER_4, _ transform: @escaping (_ rawContent1: RAW_CONTENT_1, _ rawContent2: RAW_CONTENT_2, _ rawContent3: RAW_CONTENT_3, _ rawContent4: RAW_CONTENT_4) -> OUTPUT) -> AnyPublisher<LoadingState<OUTPUT>, Self.Failure> where Self.Output == LoadingState<RAW_CONTENT_1>, PUBLISHER_2: Publisher, PUBLISHER_2.Output == LoadingState<RAW_CONTENT_2>, Self.Failure == PUBLISHER_2.Failure, PUBLISHER_3: Publisher, PUBLISHER_3.Output == LoadingState<RAW_CONTENT_3>, Self.Failure == PUBLISHER_3.Failure, PUBLISHER_4: Publisher, PUBLISHER_4.Output == LoadingState<RAW_CONTENT_4>, Self.Failure == PUBLISHER_4.Failure {
        zipState(statePublisher2) { (rawContent, other) in
            (rawContent, other)
        }
        .zipState(statePublisher3) { (rawContent, other) in
