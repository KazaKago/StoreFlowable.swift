...
public extension Publisher {
    ...
    /**
     * Combine multiple `StatePublisher`.
     *
     * - parameter statePublisher2: The second `StatePublisher` to combine.
     * - parameter transform: This callback that returns the result of combining the data.
     * - returns: Return `StatePublisher` containing the combined data.
     */
     ...
     *
     * - parameter statePublisher2: The second `StatePublisher` to combine.
     * - parameter statePublisher3: The third `StatePublisher` to combine.
     * - parameter transform: This callback that returns the result of combining the data.
     * - returns: Return `StatePublisher` containing the combined data.
     */
     ...
     * - parameter statePublisher2: The second `StatePublisher` to combine.
     * - parameter statePublisher3: The third `StatePublisher` to combine.
     * - parameter statePublisher4: The fourth `StatePublisher` to combine.
     * - parameter transform: This callback that returns the result of combining the data.
     * - returns: Return `StatePublisher` containing the combined data.
     */
     ...
     * - parameter statePublisher3: The third `StatePublisher` to combine.
     * - parameter statePublisher4: The fourth `StatePublisher` to combine.
     * - parameter statePublisher5: The fifth `StatePublisher` to combine.
     * - parameter transform: This callback that returns the result of combining the data.
     * - returns: Return `StatePublisher` containing the combined data.
     */
